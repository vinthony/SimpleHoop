...
public class UserTopic extends Activity implements ActionBar.TabListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.user_topic_main).toUpperCase(l);
                case 1:
                    return getString(R.string.user_topic_re).toUpperCase(l);
                case 2:
                    return getString(R.string.user_topic_fav).toUpperCase(l);
            }
            return null;
        }
